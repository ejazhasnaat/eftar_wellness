// lib/features/home/presentation/home_provider_screen.dart
import 'dart:async';
...
class _HomeProviderScreenState extends State<HomeProviderScreen> {
  ...
  Widget _pendingBanner() => Card(
        ...
        child: ListTile(
          ...
          title: const Text('Your provider account is pending approval'),
          subtitle:
              const Text('We’ll notify you once an admin reviews your details.'),
          trailing: TextButton.icon(
            onPressed: () => context.go('/onboarding/step2/provider'),
  ...
  Widget _rejectedBanner() => Card(
        ...
        child: ListTile(
          ...
          title: const Text('Your provider account was rejected'),
          subtitle:
              const Text('Please contact support or update and resubmit.'),
          trailing: TextButton.icon(
            onPressed: () => context.go('/onboarding/step2/provider'),
            icon: const Icon(Icons.edit_outlined),
            label: const Text('Edit profile'),
          ...
          ? Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'We don’t see your provider profile yet. '
